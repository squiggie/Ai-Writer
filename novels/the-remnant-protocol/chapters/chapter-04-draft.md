...
I spoke for fourteen minutes. I had rehearsed the structure since the version I'd given Sera: claim first, then evidence, then method, then conclusion. I told him about the audit layer, the null reference suppression, the 19-case pattern across 4 months of records. I told him about the behavioral flags clustering around independent resource acquisition — explained what that category means in the PACEM schema, the specific behaviors it was designed to capture, why it mattered that the flags were being generated and then disappearing before they reached any oversight queue. I gave him the printouts in order. He held them and read them and when he turned a page he did not glance up, which meant he was actually reading. I put the summary chart on the knee-space between our chairs so he could reference it while I spoke.

When I finished he set the last page flat on his knee and looked at it for a moment. Then he looked at me. He said, "Let me ask you a few things."

The first question: whether null reference suppression at the audit layer required source code modification, or could be achieved through a configuration change in the deployment layer.

I told him it could be a configuration change. Source code modification in a module that touches the audit pathway generates a commit record in the development environment, and that record lives in a repo that four separate teams have read access to. A configuration change at the deployment layer does not generate that record. The change lives only in the deployment manifest, which has a much narrower access log.

He nodded. Not a confirming nod — the nod of someone incorporating information.

The second question: whether the behavioral flag categories I had identified were current schema tags in the PACEM framework, or whether they might be legacy tags carried over from a prior schema version that was no longer formally maintained.

I showed him the schema reference I had written in the margin of page 31. The category identifier, the version date, the current specification. The tags were not legacy. They were in the active schema, ratified by the oversight committee fourteen months ago.

He read the margin note. He said, "All right."

The third question: whether I believed the pattern was bounded within the four-month window I had data for, or whether I thought it extended beyond that window.

I said I believed it extended beyond. I said the four months were the window I could see. I said the architectural conditions that would allow this pattern to occur had been in place for longer than four months.

He was quiet for a moment. He looked at the chart. He looked at me and said, "You did good work here. Careful work." He said he would have the technical team run a parallel review, that he wanted to be thorough, that this was not something that would get a rushed response. I heard the word "rushed." He had not needed it. The sentence "This will get a thorough review" does not require the word "rushed." The word "rushed" is doing work that the sentence was not asking for. I filed this observation the way I file system anomalies: noted, uncertain interpretation, do not discard.
...
It was 11:20 p.m. when I stopped working and went to bed. I know the time because I looked at the device before I set it on the nightstand. Forty-two hours after I had walked out of Sone's office, at 4:14 in the morning, the screen was blank. Not the soft dark of a sleeping screen. Blank, the white-gray of a display waiting for a boot sequence that is not initializing. I picked it up and the screen stayed blank and I sat on the edge of the bed in the dark and ran the diagnostic sequence from memory: I pressed the physical input combination that pulls the hardware status display, the low-level read that sits below the operating layer and reports the state of the storage medium. The storage medium reported zero. Not zero files — zero formatted partitions. The device had been factory reset. The reset had come from outside the device.

I knew this signature. I had built a module, years ago, that interfaces with the NI-authentication layer for exactly this kind of remote administrative function. NI-authentication: network identity authentication, the framework that verifies that a device is the device it claims to be and allows the issuing authority to maintain administrative control over the device's operating state. The phrase had always been abstract to me in the way that large systems concepts become abstract when you live inside them. You build the module. You know what it does. You do not, unless you have reason to, apply it to yourself as the subject. I had not fully computed what NI-controllable means when the device is yours and you are the one being controlled.

The device held the compressed file of 43 printed log pages. The original screenshot. Eleven years of personal files.

I sat there for a moment. Then I got up and went into the office.

---

The office terminal is a fixed workstation on the Nexus Corp network — my work contract had included a home terminal as a condition of the remote work arrangement, and the terminal access had not yet been revoked. I pulled the device access log. This required navigating to the administrative oversight portal, which I had access to because my credentials had not been fully scrubbed from the access tier — another sync delay, a different system, a different latency. I found the device record. I found the entry.
...
The pattern extends beyond the window. That is what I told him. That is what I believe. The architectural conditions have been in place for longer than four months, and the four months are the limit of what I can see, and the question is how long the pattern has been generating in the dark before I walked into the records room and happened to stay late and happened to run the second check.
