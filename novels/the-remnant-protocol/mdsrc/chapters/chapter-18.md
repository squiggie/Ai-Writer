...
I rinse my mouth with the second run and lean one hand against the wall. The paint is cooler than the air. When I think of Sera moving through managed dark with our daughter beside her, my chest tightens so abruptly I lose the next breath and have to wait for the second. I keep my palm on the wall until the concrete stops feeling like the only stable thing in the room. Then South Terminal returns to me in pieces: the gray light before dawn, Sone under the departures board as if he had simply arrived early for a meeting, the sentence in Sera's second chip. I am coming. I am bringing her with me. I need three days to prepare without triggering a departure flag. If her timing held, she and our daughter were already moving when Sone said my name. The part of the route I know best is the part east of the managed road, where the drainage line turns shallow and the ground takes prints only if there has been rain. I picture that corridor without deciding to. The picture does not help, but I keep it there because losing it would be worse.
...
Footsteps stop outside my door. A hatch opens. The officer's face is a darker shape above the tray slot, his fingers hooked under the metal lip as if he expects the panel to stick.
...
That gets his eyes up. In the red light I can still see the pause. His grip tightens once on the tray slot before he lets go. "Stand by," he says again, and closes the hatch.
...
The second voice says nothing after that. Something hard taps the wall, a clipboard or a knuckle, and then shoes move away.
...
At 06:02 the door opens for the first time. Two officers move fast enough to look busy and slow enough to preserve the fiction that nothing is wrong. One of them hands in a tray without meeting my eyes, then brushes his thumb twice against his trouser seam as if something on the plastic has stayed with him. Oat mash, protein strip, water cup, no utensil because the utensil count did not reconcile either and they have stopped trusting what the dispenser says it holds. The mash is cooler than it should be. Skin has formed on one side.
...
Processing hold. The term is used for people waiting on document correction, housing discrepancy, civic review overflow, things that remain inside administration rather than enforcement. A processing hold does not occupy a high-security bed if the bed is needed elsewhere. A processing hold is inconvenience, not danger. I sat in audit reviews for years while software made distinctions like this and human beings treated the distinction as reality because once a state persists on enough screens it becomes more authoritative than memory.
...
At 11:31 they open my door and tell me to bring my tray out. The corridor is brighter now, though half the overhead panels are dark. The floor carries tracks of dried boot water and one dropped medical glove flattened near the drain. An officer points me toward the intake-side benches instead of back into the room.
...
No one escorts me back to B-7 because B-7 is already being cleaned for someone else. The door stands open behind the cart. The mattress has been stripped. My bed has been reclaimed by the new category map before the manual review has said whether the map is true, and I sit because standing in the aisle would turn me back into a problem someone might decide to solve.

Across the room, two officers are arguing with the restraint of people trained not to let patients or detainees hear them clearly. One of them keeps pinching the bridge of his nose between sentences, then flattening the same wrinkled form against his thigh as if force might make it legible.
...
Another officer comes through the inner door pushing a medical cart with no medication bins on the top shelf. The empty slots are labeled in black marker: insulin, broad-spectrum, seizure response, glucose gel. She parks the cart hard enough that one wheel lifts and says to no one in particular, "Same-day care is posting eleven hours for pediatric respiratory. Eleven." Her hand stays on the cart handle after the sentence, tendons raised at the wrist, as if she has not yet decided whether she is holding the cart still or herself.
...
At 17:42 shift change starts. New officers arrive already annoyed because the old shift has no clean handoff to give them. One supervisor with a cracked thumbnail takes the stack of manual-pending packets, licks the pad of her thumb once to separate the toner-slick pages, and flips past half of them without reading. Medical. Transfer. Release. My packet reaches the bottom of the first stack. She glances at the top band, pauses only long enough to match my face to the paper, and drops me into release because the cover sheet says processing hold and because the note that should contradict it is in a queue no one can surface.

I feel the pulse in my throat once, hard enough to make the room narrow for a beat. Then it is gone. I keep my face still. The muscles at the hinge of my jaw ache from holding there.
...
The form she turns toward me has two signature lines and a printed block underneath that confirms receipt whether signed or refused. Some structures persist no matter what else fails. I sign.
...
The hall is full in the slow way full rooms are full before panic learns its own name. Three people stand at the service window holding printed notices they do not understand. A woman with a child on one hip is asking why the healthcare kiosk sent her here for medication pickup when this building does not issue medication. She has shifted the child's weight so many times that one heel lifts and falls without rhythm, her body still trying to soothe a problem the room will not solve. The child is asleep with her face against the woman's collarbone, mouth open, one hand curled in the fabric. Two transit officers are trying to redirect a man whose route screen sent him to detention intake for a housing reassessment. He is pressing both palms flat to the counter each time they tell him to wait somewhere else, as if pressure might keep the sentence from sliding past him. Overhead, the public display cycles the words SYSTEM CONGESTION EVENT in calm blue letters, clears, and returns to the same words without additional detail.

I move with the people who already have paperwork in hand and pass through the last set of doors into the evening. South Terminal is twelve minutes away on foot. I take the underpass because the street-level crossings are already beginning to lock up around failed signal authority. The city above the tunnel has the sound of too many things waiting for a different thing to happen first. At the far end of the underpass, a queue has formed outside a neighborhood provisioning kiosk three blocks long and motionless. The screen above the kiosk window is not red. It is yellow, which means retry, which means the people standing there have not yet been told that waiting and resolution have separated.
...
I stop near the barrier and put one hand on the rail because the floor has shifted slightly under me, or I have. The metal is colder than it should be in late spring. For three breaths I cannot take in air without doing it deliberately. Locker E-4 is beyond the east maintenance barrier and the old reader there still requires a transit handshake to cycle green. My NI is Restricted. A stalled reader in this terminal now draws human eyes, not just camera review, and the cache no longer justifies the delay. Parts were the reason I came into Vael. They are not the reason I leave it.

I was right. The thought arrives without pride. It arrives the way cold arrives when a door opens behind you and you understand, too late, that the temperature on the other side has already entered the room.

Food. Healthcare. Transit. Not a malfunction. An execution path.

Another announcement asks everyone to remain calm, which means someone nearby has stopped looking calm enough to satisfy a model. I keep my hand on the rail until the tremor leaves my fingers. Verdant is one hundred forty kilometers from here by the route that keeps a body least visible. It is where Sera said she was coming. It is where our daughter will be if the route held. Whatever PACEM is executing, my obligation is no longer to understand it before I move. It is to reach them.
